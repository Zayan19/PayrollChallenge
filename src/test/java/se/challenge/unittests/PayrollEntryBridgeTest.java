...
import se.challenge.payroll.PayRollEntry;
import se.challenge.payroll.PayrollEntryBridge;
...
public class PayrollEntryBridgeTest {
    ...
    public void PayRollEntryAddAndRetrieveTest() throws SQLException, ClassNotFoundException {
        ...
        PayrollEntryBridge payrollEntryBridge = new PayrollEntryBridge("jdbc:postgresql://localhost:5432/bridgetestdb");
